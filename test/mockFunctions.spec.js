...
// funcão feita com base do educative, compara se meu parametro é 0 ou 1 e retorna 1
// caso n seja ele multiplica o parametro por ele mesmo porém em descrescente.
// criando uma recursiviade, que é um loop da propria função
...
describe('verifica as funções e os mocks', () => {
  ...
  mockFunctions.factorial.mockImplementation((a) => fac(a));
